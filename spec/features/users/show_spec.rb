...
RSpec.describe 'Show Users', type: :feature do
  ...
  scenario 'Show User must display Future Users events and invited events' do
    event = Event.create name: 'Cheese', description: 'More Cheese', location: 'Cheese', date: Date.tomorrow, user_id: user.id
  ...
  scenario 'Show User must display Past Users events and attended events' do
    event = Event.new name: 'Cheese', description: 'More Cheese', location: 'Cheese', date: Date.yesterday, user_id: user.id
